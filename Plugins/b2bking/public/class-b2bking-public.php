						...
						<table class="shop_table b2bking_shop_table">
							...
							<tbody>
								...
								if ($number_of_tiers === 1){
									...
									?>
									<tr>
										<td class="tiered-quanity"><?php echo esc_html($tier_values[0]).'+'; do_action('b2bking_tiered_table_after_quantity', $post->ID); ?></td>
										...
										?>
										<td class="tiered-price"><?php echo wc_price($tier_values[1]); do_action('b2bking_tiered_table_after_price', $post->ID);?></td>
									</tr>
									<?php
								} else {
									$previous_tier = 'no';
