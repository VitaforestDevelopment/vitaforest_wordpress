  ...
  switch (currentPageUri) {
    case '/shop/industry-food-supplements/':
      ...
      document.addEventListener('scroll', () => {
        categoryDescriptionContainer.innerHTML = foodSupplementsFull.substring(0, 200) + '<button onclick="categoryDescriptionContainer.innerHTML = foodSupplementsFull;" class="read-description btn">Read more</button>';
      })
      break;
    case '/shop/industry-cosmetics/':
      categoryDescriptionContainer.innerHTML = cosmeticsFull;
      document.addEventListener('scroll', () => {
        categoryDescriptionContainer.innerHTML = cosmeticsFull.substring(0, 200) + '<button onclick="categoryDescriptionContainer.innerHTML = cosmeticsFull;" class="read-description btn">Read more</button>';
      })
      break;
    case '/shop/industry-pharmaceutical-industry/':
      categoryDescriptionContainer.innerHTML = pharmaceuticalFull;
      document.addEventListener('scroll', () => {
        categoryDescriptionContainer.innerHTML = pharmaceuticalFull.substring(0, 200) + '<button onclick="categoryDescriptionContainer.innerHTML = pharmaceuticalFull;" class="read-description btn">Read more</button>';
      })
      break;
    case '/shop/industry-healthy-nutrition/':
      categoryDescriptionContainer.innerHTML = nutritionFull;
      document.addEventListener('scroll', () => {
        categoryDescriptionContainer.innerHTML = nutritionFull.substring(0, 200) + '<button onclick="categoryDescriptionContainer.innerHTML = nutritionFull;" class="read-description btn">Read more</button>';
      })
      break;
    case '/shop/industry-feed-additives/':
      categoryDescriptionContainer.innerHTML = additivesFull;
      document.addEventListener('scroll', () => {
        categoryDescriptionContainer.innerHTML = additivesFull.substring(0, 200) + '<button onclick="categoryDescriptionContainer.innerHTML = additivesFull;" class="read-description btn">Read more</button>';
      })
      break;
    case '/shop/industry-food-and-beverages/':
      categoryDescriptionContainer.innerHTML = beveragesFull;
      document.addEventListener('scroll', () => {
        categoryDescriptionContainer.innerHTML = beveragesFull.substring(0, 200) + '<button onclick="categoryDescriptionContainer.innerHTML = beveragesFull;" class="read-description btn">Read more</button>';
      })
      break;
    default:
