...
let askButton = document.querySelector('.product__ask-link');
if (askButton) {
  askButton.addEventListener('click', () => {
    let bitrixButton = document.querySelector('.b24-widget-button-inner-container');
    bitrixButton.click();
  })
}

let wpcTermActionElement = document.querySelector('#wpc-checkbox-taxonomy-pa_productionstatus-992');
if(wpcTermActionElement){
	document.addEventListener('DOMContentLoaded', ()=>{
		if(document.location.pathname === '/en/shop/')
		wpcTermActionElement.click()
	})
}
